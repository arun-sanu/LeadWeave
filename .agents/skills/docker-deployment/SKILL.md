...
- **Dependency Caching:** Copy `package.json` and `package-lock.json` and run `npm ci` *before* copying the rest of the source code. This leverages Docker layer caching to speed up builds when code changes but dependencies do not.
