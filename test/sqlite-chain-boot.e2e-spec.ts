...
const dataDb = join(tmpdir(), `leadweave-chain-${process.pid}.sqlite`);
const mainDb = join(tmpdir(), `leadweave-chain-main-${process.pid}.sqlite`);
const keyFile = join(tmpdir(), `leadweave-chain-key-${process.pid}`);
