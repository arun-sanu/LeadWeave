 ...
 * never answer one.
 */
public class LeadWeaveServiceUnavailableError extends LeadWeaveApiError {
    public LeadWeaveServiceUnavailableError(String message, int status, Object body, String errorKind) {
