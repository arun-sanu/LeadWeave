...
import com.arunsanu.leadweave.model.AddLabelRequest;
import com.arunsanu.leadweave.model.ChatSummary;
import com.arunsanu.leadweave.model.LabelRecord;
import com.arunsanu.leadweave.model.UpsertLabelRequest;
...
public final class LabelsResource {
    ...
    public LabelsResource(LeadWeaveClient client) {
        this.client = client;
    }
