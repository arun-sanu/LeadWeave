...
export function CommandPalette({ open, onClose }: CommandPaletteProps) {
  ...
  const items: PaletteItem[] = useMemo(
    () => [
      ...
      { id: 'nav-webhooks', title: 'Webhooks & Integrations', category: 'Navigation', icon: Webhook, to: '/webhooks', keywords: ['api', 'events'] },
      ...
      { id: 'nav-team', title: 'Team & Global Users', category: 'Navigation', icon: Users, to: '/team', keywords: ['members', 'roles'] },
