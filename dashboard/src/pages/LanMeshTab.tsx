...
export const LanMeshTab: React.FC = () => {
  const { userName, hasJoined, peers, messages, isConnected, join, sendMessage, sendFile, markMessagesRead } =
    useLanMeshContext();
  ...
  if (!hasJoined) {
    return (
      ...
      >
        ...
        <form
          onSubmit={handleJoin}
          style={{ width: '100%', maxWidth: '280px', display: 'flex', flexDirection: 'column', gap: '1rem' }}
        >
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <div
            style={{
              ...
              color: isConnected ? 'var(--success)' : 'var(--error-text)',
            }}
          >
            <Network size={20} />
          </div>
            ...
            >
              <span
                style={{
                  ...
                  height: 6,
                  borderRadius: '50%',
                  background: isConnected ? 'var(--success)' : 'var(--status-failed)',
                }}
              />
      ...
      <div
        ...
        style={{ flex: '0 0 auto', maxHeight: '35%', overflowY: 'auto', borderBottom: '1px solid var(--border)' }}
      >
        <div
          style={{
      ...
      <div
        style={{ flex: 1, display: 'flex', flexDirection: 'column', background: 'var(--bg-light)', overflow: 'hidden' }}
      >
        <div
          ...
          {messages.length === 0 ? (
            ...
            >
              ...
              <p style={{ fontSize: '0.875rem', textAlign: 'center', maxWidth: '200px' }}>
                Mesh network is active. Say hello!
              </p>
            </div>
          ) : (
            messages.map((msg: import('../contexts/LanMeshContext').ChatMessage, index: number) => {
              ...
              return (
                <div
                  ...
                  style={{ marginTop: isFirstInGroup ? '0.75rem' : '0.125rem' }}
                >
                  <div className="chat-bubble">
                    ...
                    <div className="chat-bubble-text" style={{ fontSize: '0.9375rem' }}>
                      {msg.text}
                    </div>
                  </div>
                </div>
        ...
        <div
          ...
          style={{ padding: '0.75rem', borderTop: '1px solid var(--border)', background: 'var(--bg-card)' }}
        >
